...
export const QRCodeDisplay: React.FC<QRCodeDisplayProps> = ({ 
  ...
  const generateQRCode = async () => {
    ...
    try {
      ...
      // Use the URL from the backend response, or generate if not available
      const publicUrl = data.qr_code_url || `${window.location.origin}/ticket?token=${encodeURIComponent(data.qr_code_token)}`;
